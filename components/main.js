...
function typeText() {
    ...
    if(inputField.value.length == textToType.length){
        ...
        setTimeout(()=>{
            ...
            imgElement.width = 23; // Replace with the desired width in pixels
            imgElement.height = 23; // Replace with the desired height in pixels
            document.querySelector(".cricleBtn").innerHTML = ""
            document.querySelector(".cricleBtn").appendChild(imgElement)
        },2000)
        setTimeout(()=>{
            document.querySelector(".buttonLove").style.width = "215px"
...
const textLetterP = "Chúc mừng sinh nhật lần thứ 23 của hudihama!!! Hôm nay là một ngày đặc biệt, ngày một thiên thần nhỏ đáng yêu được sinh ra đời. Nhân dịp này tôi muốn gửi đến bạn những lời chúc sinh nhật thật ý nghĩa và ấm áp nhất.\n    Trước tiên, tôi chúc bạn tuổi mới luôn luôn xinh đẹp đáng yêu như bây giờ nha.\n Tôi chúc bạn luôn có được thật nhiều niềm vui và hạnh phúc, chúc bạn luôn gặp được những điều tốt đẹp nhất trong cuộc sống. Chúc bạn luôn may mắn với những lựa chọn của mình. Dù thế nào thì đối với tôi bạn vẫn luôn là người giỏi nhất. Chúng ta không quen biết gì nhau nhưng bạn luôn là một người đặc biệt trong cuộc sống của tôi.\nBạn luôn là nguồn cảm hứng và niềm vui của tôi. Tôi tự hào khi gặp được bạn trong cuộc đời mình.\nTôi hi vọng bạn sẽ đón nhận món quà này của tôi một cách vui vẻ và thoải mái.\nChúc mừng sinh nhật một lần nữa! Mong rằng ngày hôm nay sẽ đáng nhớ và đánh dấu một năm tuyệt vời tiếp theo trong cuộc đời của bạn.\nChúc bạn luôn xinh đẹp, hạnh phúc, thành công và luôn nhận được nhiều điều tốt đẹp.\n"
