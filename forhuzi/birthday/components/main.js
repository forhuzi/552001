...
$(window).on('load', function(event){
    ...
    function typeText() {
        ...
        if(inputField.value.length == textToType.length){
            ...
            setTimeout(()=>{
                document.querySelector(".buttonLove").style.width = "250px"
            ...
            setTimeout(()=>{
                document.querySelector(".button").innerHTML = "👈🏻 YOU HAVE A NEW MESSAGE"
...
const textLetterP = "Chúc mừng sinh nhật lần thứ 23 của bạn!!! Hôm nay là một ngày đặc biệt, ngày một thiên thần nhỏ đáng yêu được sinh ra đời. Nhân dịp này tôi muốn gửi đến bạn những lời chúc sinh nhật thật ý nghĩa và ấm áp nhất. Trước tiên, tôi chúc bạn tuổi mới luôn luôn xinh đẹp đáng yêu như bây giờ. Tôi chúc bạn luôn có được thật nhiều niềm vui và hạnh phúc, chúc bạn luôn gặp được những điều tốt đẹp nhất trong cuộc sống. Chúc bạn luôn may mắn với những lựa chọn của mình. Dù thế nào thì đối với tôi bạn vẫn luôn là người giỏi nhất. Tôi hi vọng bạn sẽ đón nhận món quà này của tôi một cách vui vẻ và thoải mái. Chúc mừng sinh nhật một lần nữa! Mong rằng ngày hôm nay sẽ đáng nhớ và đánh dấu một năm tuyệt vời tiếp theo trong cuộc đời của bạn. Chúc bạn luôn xinh đẹp, hạnh phúc, thành công và luôn nhận được những điều tốt đẹp nhất!"
